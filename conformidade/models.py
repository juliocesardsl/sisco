...
class Rubrica(models.Model):
    ...
    filtro_vencimento = models.CharField(max_length=255, blank=True)
    filtro_valor_fixo = models.CharField(max_length=255, blank=True)
    dc_rubrica = models.CharField(max_length=255, blank=True)
    tipo_orgao_por_rubrica = models.CharField(max_length=255, blank=True)
    tipo_rubrica_analise = models.CharField(max_length=255, blank=True)
    descricao_rubrica_sigrh = models.TextField(blank=True)
    tipo_de_rubrica = models.CharField(max_length=255, blank=True)
